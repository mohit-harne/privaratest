        ...
        <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
          <div className="  about-img indexing position-relative overflow-hidden p-5 pe-0">
            <div className="">
              ...
              <img src="./img/carousel-5.jpg" alt="" width={720} height={380} />
            </div>
          </div>
        </div>
      ...
      >
        <div className="testimonial-item bg-light rounded p-3">
          <div className="bg-white border rounded p-4">
            <p>
              We could't find a better place to buy land and settle.Thanks to
              Privara and its unmatchced customer service,we found the perfect
              land for out new homw.All the amenities and facilities made lives
              easier.
            </p>
        ...
        <div className="testimonial-item bg-light rounded p-3">
          <div className="bg-white border rounded p-4">
            <p>
              What we got was then expected! We are happy to make our investment
              with Privara and we pleased with the services. The staff and
              experts from Privara helped us with every step and made everything
              clear and made the process easy.
            </p>
            <div className="d-flex align-items-center">
              <img
                className="img-fluid flex-shrink-0 rounded"
        ...
        <div className="testimonial-item bg-light rounded p-3">
          <div className="bg-white border rounded p-4">
            <p>
              ...
              actually got more than what we wanted. Truly a worthy investment.
            </p>
            <div className="d-flex align-items-center">
              <img
                className="img-fluid flex-shrink-0 rounded"
