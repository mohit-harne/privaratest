...
import Vihar_4 from "../../../../../public/img/property_logo/Vihar_4.png";
import Ams from "../../../../Components/Amslider";
import Qr from "@mui/icons-material/QrCode2";
import TabsBox from "../../../../Components/TabsBox";
import "../../../../styles/bootstrap.min.css";
import Privara_Vihar_4_Rera_Code from "../../../../../public/img/RERA/Privara_Vihar_4_Rera_Code.jpg";
...
function property4() {
  const downloadPDF = () => {
    ...
    link.download = "Privara Vihar 4 Brochure.pdf"; // Filename for the downloaded file
      ...
      content: (
        <div className="Child1">
          ...
          <p className="text-dark mb-2 text-align-justify">
            Welcome to Privara Vihar 4, an exclusive residential layout nestled
            ...
            the standout features of Privara Vihar 4 is its direct access to a
        ...
        <div className="container">
          ...
          >
            <div className="logo-container ">
              <Image src={Vihar_4} alt="Logo" className="logoprop " />
            </div>
          </div>
