            ...
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              <div className="como">
                <div className="Child1">
                  <h1 className="text-dark p-2">Kuhaasa Residency</h1>
              ...
              <div className=" pt-2">
                ...
                <ul className="list-inline ">
                  <li className="list-inline-item">{`1. Metro Station – 2 KM`}</li>
                
                  <li className="list-inline-item px-3">{`3. D mart - 2 Km`}</li>
                </ul>
                <ul className="list-inline">
                  <li className="list-inline-item">{`2. Airport – 4 km`}</li>
                 
                  <li className="list-inline-item px-3">{`4. Wardha Road – 1.5 KM`}</li>
                </ul>
              </div>
              <div className=" p-2">
