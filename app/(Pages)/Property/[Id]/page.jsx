    ...
    <div className="container">
      <div className="row g-5">
        ...
        <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
          ...
          <p class="card-title text-dark top_heading pt-2"><b>Near By</b></p>
          <ul class="list-inline ">
            <li class="list-inline-item">{`1. NCI – 1 Km`}</li>
            <li class="list-inline-item px-3">{`3. IIM’S – 1 km`}</li>
            <li class="list-inline-item px-3">{`4. VCA stadium – 1 KM`}</li>
          </ul>
          <ul class="list-inline">
            <li class="list-inline-item">{`2. AIIMS - 1km`}</li>
            <li class="list-inline-item px-3">{`5. Samruddhi Express Way – 2.5 km`}</li>
          </ul>
