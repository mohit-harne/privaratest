      ...
      <div className="container-fluid bg-white p-0">
        <div className="row g-0 align-items-center ">
          <div className="mt-4 " style={{ textAlign: "center" }}>
            <div
              className="text-center mx-auto  wow fadeInUp text-dark "
              data-wow-delay="0.1s"
            >
              <h1 className="text-dark">Known Your Founder</h1>
              <div
                className="mt-2 align-contain-center"
                style={{
                  borderTop: "3px solid",
                  width: "10%",
                  position: "relative",
                ...
                <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                  <div className="mb-4">
                    ...
                    <p className="justy">
                      ...
                      highly growing city of India — Nagpur. Driven by the
                      purpose of building “Infinite Trust” among our customers
                      and dealers, we aim to set new benchmarks in offering
                      superior real estate services.
                    </p>
                    <p>
                      Privara aims to create a seamless real estate experience
                      for everyone. We believe that real estate should be about
              ...
              <div className="row g-5 align-items-center">
                <div className="wow fadeIn" data-wow-delay="0.5s">
                  <div style={{ textAlign: "center" }}>
                    ...
                    <p>
                      Read along to find out how we created infinite trust among
                      all our customers.
                    </p>
                  </div>
