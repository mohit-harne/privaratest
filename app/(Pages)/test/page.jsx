          ...
          <div className=" tab-pane fade show p-0 active">
            <div className="row g-4">
              <div
                ...
                data-wow-delay="0.1s"
              >
               <div className="property-item rounded overflow-hidden" style={{boxShadow: "6px 6px 3px #E4F8FF", backgroundColor: "#FBFEFF"}}>
              ...
              <div
                ...
                data-wow-delay="0.3s"
              >
                <div className="property-item rounded overflow-hidden" style={{boxShadow: "6px 6px 3px  #D2F3FF", backgroundColor: "#F8FDFF"}}>
                  <div className="position-relative overflow-hidden">
                    <a href="">
              ...
              <div
                ...
                data-wow-delay="0.5s"
              >
             <div className="property-item rounded overflow-hidden" style={{boxShadow: "6px 6px 3px rgb(220, 237, 243)"}}>
                  <div className="position-relative overflow-hidden">
                    <a href="">
              ...
              <div
                ...
                data-wow-delay="0.1s"
              >
           <div className="property-item rounded overflow-hidden" style={{boxShadow: "6px 6px 3px rgb(220, 237, 243)", backgroundColor:"#FCFCFC"}}>
                  <div className="position-relative overflow-hidden">
                    <a href="">
              ...
              <div
                ...
                data-wow-delay="0.3s"
              >
             <div className="property-item rounded overflow-hidden" style={{boxShadow: "4px 4px 10px 3px lightgrey" , backgroundColor:"#FAF9F6"}}>
                  <div className="position-relative overflow-hidden">
                    <a href="">
