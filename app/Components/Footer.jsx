        ...
        <div className="row g-5">
          <div className="col-lg-3 col-md-6">
            ...
            <p className="mb-2">
              ...
              Privara Developers F-2 Saibaba Apartment , 17 Central Excise
              Colony Chhatrapati Square, Wardha Rd, Nagpur, Maharashtra 440015
            </p>
            <p className="mb-2">
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <h6 className="text-light">
              MAHA RERA REGISTRATION NUMBER →{" "}
              <span className="text-decoration-underline">A50500032697</span>
            </h6>
          </div>
          <div className="col-lg-3 col-md-6">
        ...
        <div className="copyright">
          <div className="row">
            <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
              ...
              Designed By <a className="border-bottom">Privara Devlopers</a>
            </div>
